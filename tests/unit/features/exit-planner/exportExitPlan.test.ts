 ...
 */
describe('buildExitPlanExportPayload — Supply APR (P1-1, corrected by the Supply APR Semantic-Boundary Fix)', () => {
  ...
  it('STILL exports null for manual V4 — manually asserting collateralFactor is not the same as asserting protocol.supplyApr (the exact P1-1 bug this fix closes)', () => {
...
/**
 * Export provenance — V4 Readiness Audit §12 P2-1. `buildExitPlanExportPayload`
 ...
 */
describe('buildExitPlanExportPayload — provenance (P2-1)', () => {
